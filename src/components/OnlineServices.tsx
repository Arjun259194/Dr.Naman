...
const digitalServices = [
  {
    icon: MessageSquare,
    title: "15-Min Advice Call",
    price: "Free",
    type: "Remote Advice",
    desc: "A brief preliminary audio session to discuss your health concerns, clarify simple queries, and guide your next clinical steps.",
  ...
  },
  {
    ...
    desc: "Detailed video consult (45 mins) including a structured discussion of your medical history, symptoms, and health management goals.",
  ...
  },
  {
    ...
    desc: "A review of your current prescriptions to check for potential drug-drug interactions, duplicates, and general safety guidance.",
    cta: "Request Review",
    status: "active",
  },
  {
    ...
    price: "₹800",
    type: "Report Review",
    desc: "A meticulous review of your lab assays, blood panels, and other medical reports to help translate and explain clinical markers.",
    cta: "Submit Reports",
    status: "active",
  },
];
